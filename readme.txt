...
2. tinyMCE editor plugin for easily inserting slideshow shortcode.
3. How it may look like in the frontend.
...
New widget features, shortcode and editor plugin/button
