...
Plugin URI: http://www.hostivate.com/
...
class simpleSEOSlideshowWidget extends WP_Widget {
  ...
  function form($instance) {
    ...
    $ssslinkwhat = esc_attr($instance['ssslinkwhat']);
?>
  ...
  <p>
    <label for="<?php echo $this->get_field_id('ssslinkwhat'); ?>">Choose what to link: </label>
    <select id="<?php echo $this->get_field_id('ssslinkwhat'); ?>" name="<?php echo $this->get_field_name('ssslinkwhat'); ?>" >
      <option value="image" <?php if ($ssslinkwhat == 'image') echo ' selected="selected"'; ?>>image</option>
      <option value="caption" <?php if ($ssslinkwhat == 'caption') echo 'selected="selected"'; ?>>caption</option>
      <option value="none" <?php if ($ssslinkwhat == 'none') echo 'selected="selected"'; ?>>none</option>
      <option value="both" <?php if ($ssslinkwhat == 'both') echo 'selected="selected"'; ?>>both</option>
    </select>
  </p>
...
<?php
  ...
  function update($new_instance, $old_instance)
  {
    ...
    $instance['ssslinkwhat'] = $new_instance['ssslinkwhat'];
    return $instance;
  }
  ...
  function ssoutput ($args, $instance) {
    ...
    $ssslinkwhat = empty($instance['ssslinkwhat']) ? ' ' : apply_filters('widget_ssslinkwhat', $instance['ssslinkwhat']);
      ...
      foreach ($photos as $photo) {
        ...
        if (!in_array($photoid, $sssexclude)) {
          ...
          if ($ssswi == 0) {
            ...
            if (($ssslinkwhat == 'both' || $ssslinkwhat == 'image') && $photocustlink != '') { $actslide = '<a href="'. $photocustlink .'" title="'. $phototitle .'" class="currentlink" rel="'. $ssslinkwhat .'">'. $actslide .'</a>'; }
            
            if ($photocustlink != '' && ($ssslinkwhat == 'both' || $ssslinkwhat == 'caption')) {
          ...
          if ($ssswi > 0) {
            ...
            $restslides .= '<span class="ssoptions">'. $photosrc[1] .'|'. $photosrc[2] .'|'.$phototitle .'|'. $photodescr .'|'. $photocustlink.'|'. $ssslinkwhat .'</span>';
          }
  ...
  function ssoutput ($args, $instance) {
    ...
    $ssslinkwhat = empty($instance['ssslinkwhat']) ? $sclinkwhat : apply_filters('widget_ssslinkwhat', $instance['ssslinkwhat']);
      ...
      foreach ($photos as $photo) {
        ...
        if (!in_array($photoid, $sssexclude)) {
          ...
          if ($ssswi == 0) {
            ...
            $actslide = $ssslinkwhat. '<img src="'. $photosrc[0] .'" alt="'. $photoalt .'" title="'. $phototitle .'" width="'. $photosrc[1] .'" height="'. $photosrc[2] .'" />';
            if (($ssslinkwhat == 'both' || $ssslinkwhat == 'image') && $photocustlink != '') { $actslide = '<a href="'. $photocustlink .'" title="'. $phototitle .'" class="currentlink" rel="'. $ssslinkwhat .'">'. $actslide .'</a>'; }
