...
/************ slideshow *************/
  if (jQuery('.ssslideshow').length !=0) {
    ...
    jQuery('.ssslideshow').each(function(index) {
      ...
      jQuery(".ssslideshow", newthis).hover(
        function(){jQuery('.sss-arrow-right, .sss-arrow-left', newthis).stop(true, true).fadeIn(300); },
        function () { jQuery('.sss-arrow-right, .sss-arrow-left', newthis).stop(true, true).fadeOut(300); 
      });
